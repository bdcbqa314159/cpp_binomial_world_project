...
// FuturesDynamic::FuturesDynamic(size_t fut_mat, BinomialDynamic
// &_primaryAsset)
//     : BinomialDynamic(fut_mat), primaryAsset(_primaryAsset),
//     maturity(fut_mat) { assert(fut_mat <= primaryAsset.getN());
